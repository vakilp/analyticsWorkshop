...
#Python solution
loanstats_df = (spark.read.format("csv")
...
# MAGIC 
# MAGIC create or replace temporary view loanstats_df
# MAGIC using csv
# MAGIC options (
# MAGIC   path "/databricks-datasets/lending-club-loan-stats/LoanStats_2018Q2.csv",
# MAGIC   header true,
# MAGIC   inferSchema true);
# MAGIC 
# MAGIC select * from loanstats_df
...
# MAGIC %sql --write your code here
# MAGIC 
# MAGIC select count(*) from loanstats_df
...
# DBTITLE 1,Python Solution
#Python solution
loanstats_df.printSchema()

# COMMAND ----------

# DBTITLE 1,SQL Solution
# MAGIC %sql --write your code here
# MAGIC describe loanstats_df
...
loanstats_newDF = loanstats_df.select("loan_amnt", "term", "int_rate", "installment", "grade", "emp_length", "annual_inc", "addr_state", "dti", "delinq_2yrs", "inq_last_6mths", "mths_since_last_delinq", "revol_bal", "revol_util", "out_prncp", "total_pymnt", "total_rec_prncp", "total_rec_int", "collections_12_mths_ex_med")

display(loanstats_newDF)

# COMMAND ----------

# MAGIC %sql
# MAGIC 
# MAGIC create or replace temporary view loanstats_newDF as
# MAGIC select loan_amnt, term, int_rate, installment, grade, emp_length, annual_inc, addr_state, dti, delinq_2yrs, inq_last_6mths, mths_since_last_delinq, revol_bal, revol_util, out_prncp, total_pymnt, total_rec_prncp, total_rec_int, collections_12_mths_ex_med from loanstats_df;
# MAGIC 
# MAGIC select * from loanstats_newDF
...
loanstats_newDF.printSchema()

# COMMAND ----------

# MAGIC %sql
# MAGIC 
# MAGIC describe loanstats_newDF
...
# MAGIC cast(split(term, ' ')[1] as int) as newTerm from loanstats_newDF;
# MAGIC 
...
# DBTITLE 1,Python Solution
#Python solution
collectionsDF = df.where(df["collections_12_mths_ex_med"] != 0)
collectionsDF.count()
...
# MAGIC %sql --write your code here
# MAGIC 
# MAGIC create or replace temporary view collectionsDF as
# MAGIC select * from df
# MAGIC where collections_12_mths_ex_med <> "0";
# MAGIC 
# MAGIC select count(*) from collectionsDF
...
# DBTITLE 1,Python Solution
#Python solution
display(collectionsDF.groupBy("addr_state").count())
...
# MAGIC %sql --write your code here
# MAGIC 
# MAGIC select addr_state, count(*) as count from collectionsDF
